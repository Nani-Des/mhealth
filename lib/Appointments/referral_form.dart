...
class _ReferralFormState extends State<ReferralForm> {
          ...
          child: Column(
            ...
            children: [
              Text("Referee Notes",
                  style: Theme.of(context).textTheme.headlineSmall?.copyWith(color: Colors.teal)),
              SizedBox(height: 24),
              _buildTextField(_examinationFindingsController, "Examination Findings (Optional)", maxLines: 3, isRequired: false),
              SizedBox(height: 16),
              _buildTextField(_treatmentAdministeredController, "Treatment Administered (Optional)", maxLines: 3, isRequired: false),
              SizedBox(height: 16),
              _buildTextField(_diagnosisController, "Diagnosis (Optional)", maxLines: 2, isRequired: false),
              SizedBox(height: 16),
              _buildTextField(_reasonForReferralController, "Reason for Referral", maxLines: 3, isRequired: true),
              SizedBox(height: 24),
              _buildUploadButton(),
              SizedBox(height: 32),
  ...
  Widget _buildUploadButton() {
    return OutlinedButton.icon(
      ...
      label: Text(
        _uploadedFileName == null ? "Add Attachments" : "Uploaded: $_uploadedFileName",
